  ...
  green4: {
    ...
    advise: {
      contents: [
        ...
        {
          title: "ให้ญาติผู้พบเห็นเหตุการณ์ เฝ้าสังเกตอาการผู้ป่วยอย่างใกล้ชิด",
          descriptions: ["หากมีอาการเปลี่ยนแปลงให้โทร 1669 อีกครั้ง"]
        }
      ],
      notes: [
        "1. อย่าให้ผู้ป่วยดื่ม/กิน สิ่งใด และไม่ราดน้ำรดตัวผู้ป่วย",
  ...
  green5: {
    ...
    advise: {
      contents: [
        {
          title: "อย่าทำให้ผู้ป่วยอาเจียน ",
          descriptions: ["อย่าทำให้ผู้ป่วยดื่ม/กินสิ่งใด"]
        },
        {
          title: "ให้ญาติผู้พบเห็นเหตุการณ์ เฝ้าสังเกตอาการผู้ป่วยอย่างใกล้ชิด",
          descriptions: ["หากมีอาการเปลี่ยนแปลงให้โทร 1669 อีกครั้ง หรือนำส่งโรงพยาบาลที่ใกล้ที่สุด"]
        }
      ],
      notes: []
    }
