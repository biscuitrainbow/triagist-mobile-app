			...
			contents: [
				{
					...
					descriptions: [ 'ระวังอันตรายที่อาจเกิดขึ้นกับผู้ป่วยและผู้อื่น  ให้เคลื่อนย้ายวัตถุสิ่งของมีคมออกจากบริเวณใกล้เคียง' ],
				},
				{
				...
				{
					title: '3. ไม่สร้างสิ่งกระตุ้นหรือสิ่งเร้าที่ทำให้ผู้ป่วยหวาดระแวงและอาจทำร้ายผู้อื่น  ทำร้ายตัวเองหรือทรัพย์สิน',
					descriptions: [],
				},
				{
					title: '4. ผู้ช่วยเหลือให้อยู่บริเวณทางออกที่สะดวก ',
					descriptions: [ 'เช่น  บริเวณประตู  ปากซอย  เพื่อความปลอดภัยของตนเอง  ในกรณีผู้ป่วยคลุ้มคลั่งและจะทำร้ายผู้อื่น' ],
				},
				{
	...
	green7: {
		...
		advise: {
			contents: [
				...
				{
					title: '2. ไม่สร้างสิ่งกระตุ้นหรือสิ่งเร้าที่ทำให้ผู้ป่วยหวาดระแวงและอาจทำร้ายผู้อื่น ทำร้ายตัวเองหรือทรัพย์สิน',
					descriptions: [],
				},
				{
