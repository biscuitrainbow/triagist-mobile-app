...
const result = {
  ...
  green7: {
    ...
    advise: {
      contents: [
        {
          title: "1.เคลื่อนย้ายผู้ป่วยมายังสถานที่ที่ปลอดภัย",
          descriptions: []
        },
        {
          title: "2.กรณีสารเคมีปนเปื้อน ให้ถอดเสื้อผ้าที่เปื้อนสารเคมี ",
          descriptions: [
            "ให้ถอดเสื้อผ้าที่ปนเปื้อนออก กรณีสารเคมีเข้าตา ให้รินน้ำผ่านตามากๆ กรณีสารเคมีเป็นผง ให้ปัดออกห้ามใช้น้ำล้าง"
          ]
        },
        {
          title: "3.สังเกตอาการผู้ป่วย หากมีอาการเปลี่ยนแปลงแนะนำให้ญาติพาผู้ป่วยไปรับการรักษาที่โรงพยาบาลใกล้บ้าน",
          descriptions: []
        }
      ],
      notes: []
