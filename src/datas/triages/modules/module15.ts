...
const result = {
  ...
  yellow8: {
    ...
    advise: {
      ...
      notes: ["1. ผู้ป่วยมีอาการเปลี่ยนแปลงให้โทร 1669 อีกครั้ง เพื่อรับวิธีการปฐมพยาบาล ระหว่างรอรถพยาบาล"]
    }
  },
  yellow7: {
    code: "15 เหลือง 7",
  ...
  green2: {
    ...
    advise: {
      contents: [
        ...
        {
          title: "2. ให้ญาติผู้พบเห็นเหตุการณ์ เฝ้าสังเกตอาการผู้ป่วยอย่างใกล้ชิด",
          descriptions: ["หากมีอาการเปลี่ยนแปลงแนะนำให้โทร 1669 หรือนำส่งโรงพยาบาลที่ใกล้ที่สุด"]
        }
      ],
      notes: []
    }
