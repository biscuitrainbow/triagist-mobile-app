  ...
  red6: {
    ...
    advise: {
      contents: [
        ...
        {
          title: "2. ให้ผู้ป่วยนอนอยู่ในท่าที่บาดแผลงูพิษกัดอยู่ต่ำกว่าระดับหัวใจ ",
          descriptions: ["นอนอยู่นิ่งๆ  เคลื่อนไหวร่างกายให้น้อยที่สุด และควรปลอบใจให้ผู้ป่วยสบายใจ"]
        },
        {
          title: "3. รีบนำผู้ป่วยส่งโรงพยาบาลที่ใกล้ที่สุด",
          descriptions: ["ถ้านำสัตว์ที่กัดไปด้วยหรือบอกชื่อของสัตว์ที่กัดได้ด้วยยิ่งดี "]
        }
      ],
      notes: [
        "1. หากผู้ป่วยเริ่มรู้สึกตัว / หายใจเองได้ หรือ  อาเจียน ให้จัดท่านอนตะแคง เพื่อให้ทางเดินหายใจโล่ง  คลายเสื้อผ้าให้หลวม",
  ...
  yellow1: {
    ...
    advise: {
      contents: [
        ...
        {
          title: "3. กรณีแผลเหวอะหวะให้ปล่อยแผลไว้",
          descriptions: ["โดยไม่ต้องเย็บแผลแต่ปิดแผลด้วยผ้าก๊อซสะอาด"]
        },
        {
          title: "4. แนะนำให้ฉีดยาวัคซีนป้องกันโรคบาดทะยักและวัคซีนป้องกันพิษสุนัขบ้าที่โรงพยาบาลหรือสถานีอนามัย",
          descriptions: []
        }
      ],
      notes: ["หากมีอาการแน่นหน้าอก  หายใจติดขัด เหงื่อออกตัวเย็น ซึมลง ให้แจ้งกลับมาทาง 1669 อีกครั้ง"]
    }
  },
  yellow2: {
    code: "3 เหลือง 2",
    ...
    advise: {
      contents: [
        ...
        {
          title: "2. ให้ญาติผู้พบเห็นเหตุการณ์เฝ้าสังเกตอาการผู้ป่วยอย่างใกล้ชิด ",
          descriptions: [
            "จนกว่ารถพยาบาลจะมาถึง และรวบรวมยาประจำตัวผู้ป่วยและผู้พบเห็นเหตุการณ์ ขึ้นรถพยาบาลไปพร้อมกับผู้ป่วยด้วย เพื่อให้ประวัติแก่ แพทย์ และเจ้าหน้าที่พยาบาล"
          ]
        }
